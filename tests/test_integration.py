...
class TestIntegration:
    ...
    def test_complex_card_creation(self):
        ...
        # 验证所有元素都创建成功
        expected_tags = ["markdown", "hr", "text", "hr", "markdown", "text", "text", "text", "hr", "button", "button"]
