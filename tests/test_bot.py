...
def test_bot_initialization_with_config():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        # 先保存配置
        bot1 = LarkBot(webhook_url, save_config=True)
...
def test_bot_send_methods():
    ...
    print("发送带按钮的卡片...")
    buttons = [
        {"content": "访问 GitHub", "url": "https://github.com/Benature/larkpy"},
        {"content": "查看文档", "url": "https://github.com/Benature/larkpy#readme"}
    ]
    
    response3 = bot.send_card(
        content="这是带按钮的卡片测试",
        title="按钮卡片测试",
        buttons=buttons,
        template="green",
    ...
    payload = [
        {"tag": "text", "text": "这是 payload 格式的消息"},
        {"tag": "a", "text": "点击链接", "href": "https://github.com/Benature/larkpy"}
    ]
...
def test_bot_collapsible_panel():
    ...
    # 生成折叠面板
    panel = bot.gen_collapsible_panel(
        content="这是折叠面板的内容，可以包含很长的文本...",
        title="📋 详细信息",
        expanded=False,
